...
function AllRooms() {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        {/* Filter */}
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lgt-16'>
            ...
            <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} overflow-x-hidden transition-all duration-700`}>
